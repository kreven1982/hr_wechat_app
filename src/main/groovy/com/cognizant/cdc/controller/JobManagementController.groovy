...
class JobManagementController {
    ...
    List<Job> sampleJobs = [
            ...
            new Job(id: 5, locations: ["Shanghai","Tianjing","Shenzhen"],experienceFrom: 3, experienceTo: 8, title: "Cognos Engineer / Senior Engineer", content: "Good English writing skill; Experienced in Cognos Report Studio, Analysis Studio, Business Insight, Framework Manager and Transformer, SSIS; Solid knowledge of SQL."),
